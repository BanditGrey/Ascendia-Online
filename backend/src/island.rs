...
async fn status(state: web::Data<Arc<AppState>>, user: AuthenticatedUser) -> AppResult<HttpResponse> {
    ...
    Ok(HttpResponse::Ok().json(serde_json::json!([
        ...
        {"island":"deep_nightmare","name":"Pesadelo Profundo","range":"1101-1150","theme":"Pesadelo profundo com torres","requirement":"Fase 1100 + 55000 Gold + VIP 15 + Despertar 5 + Power 180000","max_stage":max_stage,"vip":vip,"awak":awak,"can_unlock":unlocked_nightmare && max_stage>=1100 && gold>=55000 && vip>=15 && awak>=5,"unlocked":unlocked_deep,"island_max":island_max_deep,"mobs":["deep_nightmare_horror","deep_nightmare_wraith","deep_nightmare_spawn"],"boss":"Pesadelo Profundo 1150","loot":"Lâmina do Pesadelo Profundo, Armadura do Pesadelo Profundo, Coroa do Pesadelo Profundo"}
    ])))
}
