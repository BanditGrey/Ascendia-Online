-- Ilha 21: Sonho Lúcido (1001-1050) — Mecânica Sono (50% stats, 200% loot)
-- Requer Vazio Supremo 1000 + 45000 Gold + VIP 15 + Despertar 5 + Power 120000

INSERT INTO item_templates (code,name,slot,rarity,base_stats,min_stage,tier) VALUES
('dream_blade_primordial','Lâmina Onírica','main_hand','primordial','{"attack":650,"crit_rate":0.16}',1001,8),
('dream_armor_primordial','Armadura Onírica','chest','primordial','{"defense":650,"hp":6000}',1015,8),
('dream_crown_primordial','Coroa do Sonho','head','primordial','{"attack":750,"defense":650,"hp":7000}',1050,8)
ON CONFLICT (code) DO NOTHING;

INSERT INTO cosmetic_skins (cosmetic_type, tier, skin_code, name, tradable) VALUES
('wings',8,'wings_t8_dream','Asas Oníricas — Ilha 21 Sonho', true),
('aura',8,'aura_t8_dream','Aura Onírica — Ilha 21', true)
