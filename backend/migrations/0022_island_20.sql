-- Ilha 20: Vazio Supremo (951-1000) — Pós-Abismo Final
-- Requer Abismo Final 950 + 40000 Gold + VIP 15 + Despertar 5 + Power 100000

INSERT INTO item_templates (code,name,slot,rarity,base_stats,min_stage,tier) VALUES
('supreme_blade_primordial','Lâmina Suprema','main_hand','primordial','{"attack":600,"crit_rate":0.15}',951,8),
('supreme_armor_primordial','Armadura Suprema','chest','primordial','{"defense":600,"hp":5000}',965,8),
('supreme_crown_primordial','Coroa Suprema','head','primordial','{"attack":700,"defense":600,"hp":6000}',1000,8)
ON CONFLICT (code) DO NOTHING;

INSERT INTO cosmetic_skins (cosmetic_type, tier, skin_code, name, tradable) VALUES
('wings',8,'wings_t8_supreme','Asas Supremas — Ilha 20', true)
