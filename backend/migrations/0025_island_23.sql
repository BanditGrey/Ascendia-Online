-- Ilha 23: Pesadelo Profundo (1101-1150) — Pós-Pesadelo, mecânica Pesadelo 300% loot
-- Requer Pesadelo 1100 + 55000 Gold + VIP 15 + Despertar 5 + Power 180000

INSERT INTO item_templates (code,name,slot,rarity,base_stats,min_stage,tier) VALUES
('deep_nightmare_blade_primordial','Lâmina do Pesadelo Profundo','main_hand','primordial','{"attack":750,"crit_rate":0.19}',1101,8),
('deep_nightmare_armor_primordial','Armadura do Pesadelo Profundo','chest','primordial','{"defense":750,"hp":8000}',1115,8),
('deep_nightmare_crown_primordial','Coroa do Pesadelo Profundo','head','primordial','{"attack":850,"defense":750,"hp":9000}',1150,8)
ON CONFLICT (code) DO NOTHING;

INSERT INTO cosmetic_skins (cosmetic_type, tier, skin_code, name, tradable) VALUES
('wings',8,'wings_t8_deep_nightmare','Asas do Pesadelo Profundo — Ilha 23', true)
