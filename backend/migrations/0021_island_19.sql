-- Ilha 19: Abismo Final (901-950) — Conteúdo pós-Origem
-- Requer Origem 900 + 35000 Gold + VIP 15 + Despertar 5 + Power 75000

INSERT INTO item_templates (code,name,slot,rarity,base_stats,min_stage,tier) VALUES
('final_blade_primordial','Lâmina do Abismo Final','main_hand','primordial','{"attack":550,"crit_rate":0.13}',901,8),
('final_armor_primordial','Armadura Final','chest','primordial','{"defense":550,"hp":4000}',915,8),
('final_crown_primordial','Coroa Final','head','primordial','{"attack":650,"defense":550,"hp":4500}',950,8)
ON CONFLICT (code) DO NOTHING;

INSERT INTO cosmetic_skins (cosmetic_type, tier, skin_code, name, tradable) VALUES
('wings',8,'wings_t8_final','Asas Finais — Ilha 19', true),
('aura',8,'aura_t8_final','Aura Final — Ilha 19', true)
